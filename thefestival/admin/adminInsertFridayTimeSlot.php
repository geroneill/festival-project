...
//if(!isset($_SESSION))
//?>
<!--Admin can allocate day and time slot for Friday 10 July -->
<!doctype html>
<html lang="en">
  <head>
  <?php
...
<form method='POST' action='processinsertTimeSlot.php' enctype='multipart/form-data' >
  ...
  <div class="form-group">
    <label for="allocateDateTime">Friday 10 July 2020</label>
    <select class="form-control" name="date" id="exampleFormControlSelect1">
      <option>2020-07-10</option>
      <option>2020-07-10</option>
      <option>2020-07-10</option>
      <option>2020-07-10</option>
    </select>
    ...
    <select class="form-control" name="time" id="exampleFormControlSelect1">
      <option>2020-07-10 19:00:00</option>
      <option>2020-07-10 20:00:00</option>
      <option>2020-07-10 21:00:00</option>
      <option>2020-07-10 22:00:00</option>
    </select>
  </div>
  <div class="form-group">
