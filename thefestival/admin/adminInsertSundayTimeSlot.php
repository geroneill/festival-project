...
<form method='POST' action='processinsertTimeSlot.php' enctype='multipart/form-data' >
  ...
  <div class="form-group">
    <label for="allocateDateTime">Sunday 12 July 2020</label>
    <select class="form-control" name="date" id="exampleFormControlSelect1">
      <option>2020-07-12</option>
      <option>2020-07-12</option>
      <option>2020-07-12</option>
      <option>2020-07-12</option>
    </select>
    ...
    <select class="form-control" name="time" id="exampleFormControlSelect1">
      <option>2020-07-12 19:00:00</option>
      <option>2020-07-12 20:00:00</option>
      <option>2020-07-12 21:00:00</option>
      <option>2020-07-12 22:00:00</option>
    </select>
  </div>
  <div class="form-group">
